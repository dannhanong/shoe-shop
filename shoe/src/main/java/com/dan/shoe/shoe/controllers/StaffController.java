...
public class StaffController {
    ...
    public ResponseEntity<Page<Staff>> getAllStaffsByKeyword(@RequestParam(defaultValue = "") String keyword,
        ...
        return ResponseEntity.ok(staffService.getAllStaffsByKeyword(keyword, pageable));
    }
